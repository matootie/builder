...
import Protected, { UserContext } from "@components/protected"
import Image from "next/image"

const defaultUser = {
  name: "Marvin Zooney",
  email: "marvin@zooney.com",
                ...
                <div className="flex justify-between h-16">
                  <div className="flex">
                    <div className="flex-shrink-0 flex items-center">
                      <div className="block relative h-8 w-8">
                        <Image
                          layout="fill"
                      ...
                      <div>
                        <Menu.Button className="bg-white flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                          ...
                          <Image
                            ...
                            src={user.picture || defaultUser.imageUrl}
                            alt=""
                          />
                        </Menu.Button>
                      </div>
...
Home.getLayout = (page) => <Protected>{page}</Protected>
