...
export const Layout: FC = ({ children }) => {
  ...
  const { isLoading, error, data } = useQuery<Guild[]>(
    "serverData",
    async () => {
      const token = await getAccessToken()
      const response = await fetch(
        "https://ewd7bib827.execute-api.ca-central-1.amazonaws.com/prod/guilds",
        {
          headers: {
              ...
              <Routes>
                <Route
                  ...
                  element={
                    ...
                    <Settings guild={servers.find((x) => x.id === serverId)} />
                  }
                />
              </Routes>
              {/* End main area */}
