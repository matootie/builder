                  ...
                  <nav aria-label="Sidebar" className="mt-5">
                    <div className="px-2 space-y-1">
                      {servers ? (
                        ...
                        <span className="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md animate-pulse">
                          <img
                  ...
                  <div className="px-2 space-y-1">
                    {servers
                      ...
                      : [...Array(3)].map((_v, index) => (
                          <span
                            key={index}
                            className="bg-gray-200 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md animate-pulse odd:delay-75"
                          >
                            <img
                              src="https://cdn.discordapp.com/embed/avatars/0.png"
                              className="mr-3 h-6 w-6 rounded-md"
